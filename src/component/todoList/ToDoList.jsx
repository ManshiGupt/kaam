...
import { deleteTheTodo, editTheTodo, getTheTodo, postTheTodo } from "../../../services/toDoListApi";
...
{editedRes.todo}
      ...
      <form onSubmit={handle}>
        ...
        <input
          ...
          placeholder="userId"
        />
        <button className="border p-4 bg-slate-500" type="submit">
          create new
        </button>
      </form> */}
      <ul>
        ...
        />
              {/* <div>{data.id}</div> */}
               <button onClick={()=>handleDeelte(data.userId)} className="px-5">Delete</button>
